package com.example.herpiko.peta;
...
public class MapsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMap.addMarker(new MarkerOptions().title("STT NF Kampus A").snippet("Kampus A STT NF"))
                .position(kampus_a);
        mMap.addMarker(new MarkerOptions().title("STT NF Kampus B").snippet("Kampus B STT NF"))
                .position(kampus_b);
